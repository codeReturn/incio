...
import stripeBigIcon from '../images/socials/stripeBig.webp';
...
const Account = () => {
    ...
    const callZoom = async () => {
        await connectToService('zoom', userData.userId, userData.token);
    };
      
    const callGoogle = async () => {
        await connectToService('google', userData.userId, userData.token);
    };  

    const callStripe = async () => {
        await connectToService('stripe', userData.userId, userData.token);
    };  
    ...
    <React.Fragment>
      ...
      <Modal show={show} size='lg' onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>Connect Apps</Modal.Title>
        </Modal.Header>
        <Modal.Body>
            <div className="modal-socials-list">
                <div className="modal-socials-block">
                    <Row>
                        <Col sm={3}>
                                <div className="modal-socials-block-image text-center">
                                    <img src={zoomIcon} className="img-fluid" style={{ maxHeight: "100px" }} />
                                </div>
                        </Col>
                        <Col sm={6}>
                                <div className="modal-socials-block-info">
                                    <h3>Zoom</h3>
                                    <p>By connecting your Zoom, you Automatically create Zoom meetings at the time an event is scheduled andInstantly share unique conferencing details upon confirmation.</p>
                                </div>
                        </Col>
                        <Col sm={3}>
                                <Button variant='dark' className='m-4' onClick={() => callZoom()}>Connect</Button>
                        </Col>
                    </Row>
                </div>
                ...
                <div className="modal-socials-block">
                    <Row>
                        <Col sm={3}>
                                <div className="modal-socials-block-image text-center">
                                    <img src={googleIcon} className="img-fluid" style={{ maxHeight: "100px" }} />
                                </div>
                        </Col>
                        <Col sm={6}>
                                <div className="modal-socials-block-info">
                                    <h3>Google</h3>
                                    <p>By connecting your Google Account, you automatically create meeting events on your google calendar saving you time & energy.</p>
                                </div>
                        </Col>
                        <Col sm={3}>
                                <Button variant='dark' className='m-4' onClick={() => callGoogle()}>Connect</Button>
                        </Col>
                    </Row>
                </div>
                ...
                <div className="modal-socials-block">
                    <Row>
                        <Col sm={3}>
                                <div className="modal-socials-block-image text-center">
                                    <img src={stripeBigIcon} className="img-fluid" style={{ maxHeight: "100px" }} />
                                </div>
                        </Col>
                        <Col sm={6}>
                                <div className="modal-socials-block-info">
                                    <h3>Stripe</h3>
                                    <p>By connecting your Stripe, you can create/send invoices from here and also reviewing all of your payment history.</p>
                                </div>
                        </Col>
                        <Col sm={3}>
                                <Button variant='dark' className='m-4' onClick={() => callStripe()}>Connect</Button>
                        </Col>
                    </Row>
                </div>
      ...
      <Container fluid>
        <Row className="flex-xl-nowrap">
          ...
          <Col xs={12} md={9} lg={10} className="p-0">
             ...
             <Row>
                ...
                <div className="section-title custom-padding-top">
                    <h1>Personal</h1>
                        ...
                        <TimezoneSelector userId={user && user._id} onUpdate={() => console.log('profile')} />
                ...
                <Col sm={6}>
                <div className="section-title custom-padding-top">
                    <Button variant='dark' className='connect-apps-btn' onClick={handleShow}>Connect Apps</Button>
                                    ...
                                    <React.Fragment key={`social` + index}>
                                        <Col sm={6}>
                                            <div className="account-social">
                                                <Button variant='light' size='sm' className='float-end discbtn' onClick={() => removeSocial(social.platform)}><i className="fa-solid fa-xmark"></i></Button>
            ...
            <>
                <Button variant='dark' size='lg' className='w-100 my-4 acc-logout' onClick={() => {
                    auth.logout()
                }}>Sign Out</Button>
            </>
            )}
