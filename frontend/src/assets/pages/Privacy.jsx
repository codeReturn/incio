...
const Privacy = () => {
    return (
		...
		<div className="page">
		    ...
		    <p><small>Last updated: July 05, 2023</small></p>
			...
			<p>	For the purposes of this Privacy Policy:</p>
			  ...
			  <li>Company (referred to as either "the Company", "We", "Us" or "Our" in this
			    Agreement) refers to Millionaire Advertising FZE, Marina, Dubai, United
			    Arab Emirates.</li>
			 ...
			 <li>Service refers to the Website.</li>
			  ...
			  <li>Website refers to Incio, accessible from [incio.io](incio.io)</li>
			...
			identifiable information that can be used to contact or identify You.</p>
		...
		<p>We use Cookies and similar tracking technologies to track the activity on Our
			...
			cookies on the <a href="https://www.freeprivacypolicy.com/blog/sample-privacy-policy-
			template/#Use_Of_Cookies_And_Tracking" target="_blank">Free Privacy Policy
			website article</a>.</p>
			...
			<p>	We use both Session and Persistent Cookies for the purposes set out below:</p>
			  ...
			  <li>Cookies Policy / Notice Acceptance Cookies<br />
			    ...
			    every time You use the Website.</li>
		...
		<p>		If you have any questions about this Privacy Policy, You can contact us:</p>	
			  ...
			  <p>By email: <a href="mailto:support@incio.io">mailto:support@incio.io</a></p>

			  <p>By visiting this page on our website: <a href="incio.io">link</a></p>
			

			<h1>Google API Policy</h1>
			<p>This passage outlines the practices and policies regarding the access, usage, storage, and sharing of Google user data within our application. We are committed to ensuring the security and privacy of user information while providing a seamless experience for users who choose to connect their Google account with our App. Please read this passage very carefully to understand how your data is managed within our application.</p>
			
			<h3>Data Collection and Access:</h3>
			<p>When a user chooses to connect their Google account to our application, we request authorization to access specific data from their Google account. This authorization is obtained through a secure authentication process that adheres to industry standards and best practices. Once authorized, our application collects the necessary access and refresh tokens from Google, which are then securely stored in our MongoDB database.</p>

			<h3>Secure Token Storage:</h3>
			<p>User tokens, including access and refresh tokens, are securely stored in our MongoDB database. These tokens are associated with a unique user identifier and are encrypted using state-of-the-art encryption mechanisms. This ensures that user data remains confidential and protected from unauthorized access.</p>
		
			<h3>Purpose of Token Storage:</h3>
			<p>The primary purpose of storing user tokens is to provide a seamless and uninterrupted experience within our application. These tokens are used to facilitate ongoing interactions with Google services on behalf of the user, such as fetching data or performing actions authorized by the user.</p>
		
			<h3>Limited Access and Sharing:</h3>
			<p>User tokens are used exclusively for the functioning of our application and are never shared with third parties, unless explicitly required to provide a specific service requested by the user. Our application does not publicly expose or make visible any user tokens. Access to user tokens is restricted to authorized personnel within our organization who require this access for application maintenance and support purposes.</p>
		
			<h3>User Control and Transparency:</h3>
			<p>Our application provides users with a dedicated section where they can manage their connected accounts, including the ability to revoke access to Google services at any time. Users can also view the types of data our application has access to and the permissions granted. We are committed to empowering users with control over their data and ensuring transparency in our data practices.</p>
		
			<h3>Compliance and Regulations:</h3>
			<p>Incio’s use and transfer to any other app of information received from Google APIs will adhere to <a href="https://developers.google.com/terms/api-services-user-data-policy#additional_requirements_for_specific_api_scopes" target="_blank">Google API Services User Data Policy</a>, including the Limited Use requirements.</p>
		
			<p>We also  adhere to relevant data protection and privacy regulations, including but not limited to the General Data Protection Regulation (GDPR) and the California Consumer Privacy Act (CCPA). Our practices are designed to safeguard user data and privacy rights in accordance with these regulations.</p>
		</div>
        </>
    )
}
